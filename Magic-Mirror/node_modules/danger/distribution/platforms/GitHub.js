...
exports.GitHub = function (api) {
    ...
    return __assign({ name: "GitHub", api: api, getReviewInfo: api.getPullRequestInfo, getPlatformGitRepresentation: function () { return GitHubGit_1.default(api); }, getPlatformDSLRepresentation: function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        }); } }, issueCommenter_1.GitHubIssueCommenter(api), (checksCommenter_1.GitHubChecksCommenter(api) || {}), { getFileContents: api.fileContents });
};
