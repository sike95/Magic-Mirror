...
var GitHubAPI = /** @class */ (function () {
    function GitHubAPI(repoMetadata, token) {
        ...
        this.getExternalAPI = function (accessTokenForApp) {
            var host = process.env["DANGER_GITHUB_API_BASE_URL"] || undefined;
            var options = {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, allComments
                                .filter(function (comment) { return v.includes(comment.body, dangerIDMessage); }) // does it contain the right danger ID?
                                .filter(function (comment) { return comment.user.id === userID; }) // Does it have the right user ID?
                                .filter(function (comment) { return v.includes(comment.body, githubIssueTemplate_1.dangerSignaturePostfix); }) // Does it look like a danger message?
        ...
        this.deleteInlineCommentWithID = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repo = this.repoMetadata.repoSlug;
                        return [4 /*yield*/, this.api("repos/" + repo + "/pulls/comments/" + id, {}, {}, "DELETE", false)
        ...
        this.postCheck = function (check, token) { return __awaiter(_this, void 0, void 0, function () {
            var repo, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
