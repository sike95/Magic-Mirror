 ...
 */
exports.findPositionForInlineComment = function (git, line, path) {
 ...
 * @param api
 */
exports.GitHubIssueCommenter = function (api) {
    var d = debug_1.debug("GitHub::Issue");
    return {
         ...
         * then return true.
         */
        updateStatus: function (passed, message, url) { return __awaiter(_this, void 0, void 0, function () {
            var ghAPI, prJSON, ref, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ghAPI = api.getExternalAPI();
                    ...
                    case 4:
                        ...
                        // @ts-ignore
                        if (global.verbose) {
                            console.log("Got an error with creating a commit status", error_1);
                        }
        ...
        createInlineComment: function (git, comment, path, line) {
            ...
            return exports.findPositionForInlineComment(git, line, path).then(function (position) {
