...
var BitBucketServer = /** @class */ (function () {
    function BitBucketServer(api) {
        var _this = this;
        this.api = api;
        this.d = debug_1.debug("BitBucketServer");
        /**
            ...
            return git.structuredDiffForFile(path).then(function (diff) {
                return new Promise(function (resolve, reject) {
                    ...
                    for (var _i = 0, _a = diff.chunks; _i < _a.length; _i++) {
                        ...
                        change = chunk.changes.find(function (c) { return c.type != "del" && c.destinationLine == line; });
                        break;
                    }
                    if (change === undefined) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 9:
                        ...
                        return [2 /*return*/, issue && issue.id && host + "/" + repoSlug + "/pull-requests/" + pullRequestID + "/overview?commentId=" + issue.id];
                }
            });
        });
    };
