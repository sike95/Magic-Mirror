...
exports.gitJSONToGitDSL = function (gitJSONRep, config) {
    ...
    var JSONPatchForFile = function (filename) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    headFile = _a.sent();
                    baseJSON = baseFile === "" ? {} : JSON5.parse(baseFile);
                    headJSON = headFile === "" ? {} : JSON5.parse(headFile);
    ...
    var structuredDiffForFile = function (filename) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!config.getFullStructuredDiff) return [3 /*break*/, 2];
                    return [4 /*yield*/, config.getFullStructuredDiff(config.baseSHA, config.headSHA)];
                case 1:
                    fileDiffs = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, config.getFullDiff(config.baseSHA, config.headSHA)];
                case 3:
                    diff = _a.sent();
