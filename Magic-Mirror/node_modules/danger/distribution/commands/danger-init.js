...
var go = function (app) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                state = state_setup_1.generateInitialState(process);
                ui = state_setup_1.createUI(state, app);
                if (!state.isGitHub) {
...
var setupDangerfile = function (ui, state) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                content = default_dangerfile_1.generateDefaultDangerfile(state);
...
var setupGitHubAccount = function (ui, state) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                ui.say("This means only providing access to " + interfaces_1.highlight("public_repo") + " in the token.");
                return [4 /*yield*/, ui.pause(1)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                ui.say("This means only providing access to " + interfaces_1.highlight("repo") + ", and its children in the token.\n\n");
                return [4 /*yield*/, ui.pause(1)];
            case 4:
                _a.sent();
                ui.say("It's worth noting that you " + chalk_1.default.bold.red("should not") + " re-use this token for OSS repos.");
                ui.say("Make a new one for those repos with just " + interfaces_1.highlight("public_repo") + ".");
                return [4 /*yield*/, ui.pause(1)];
            case 5:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ui.say("- One of the best ways to test out new rules as you build them is via " + interfaces_1.highlight("bundle exec danger pr") + ".");
                return [4 /*yield*/, ui.pause(0.6)];
            case 1:
                _a.sent();
                ui.say("- You can have Danger output a lot of info via the " + interfaces_1.highlight("--verbose") + " option.");
                return [4 /*yield*/, ui.pause(0.6)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                link("facebook/react-native#danger/dangerfile.js", "https://github.com/facebook/react-native/blob/master/danger/dangerfile.js");
                link("apollographql/apollo-client#dangerfile.ts", "https://github.com/apollographql/apollo-client/blob/master/dangerfile.ts");
                link("styled-components/styled-components#dangerfile.js", "https://github.com/styled-components/styled-components/blob/master/dangerfile.js");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, add_to_ci_1.travis(ui, state)];
            case 2:
                _a.sent();
                return [3 /*break*/, 7];
            case 3:
                if (!(state.ciType === "circle")) return [3 /*break*/, 5];
                return [4 /*yield*/, add_to_ci_1.circle(ui, state)];
            case 4:
                _a.sent();
                return [3 /*break*/, 7];
            case 5: return [4 /*yield*/, add_to_ci_1.unsure(ui, state)];
            case 6:
                _a.sent();
                _a.label = 7;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                ui.say("If you like Danger, let others know. If you want to know more, follow " +
                    interfaces_1.highlight("@orta") +
                    " and " +
                    interfaces_1.highlight("@DangerSystems") +
                    " on Twitter.");
