 ...
 */
export declare const runDangerfileEnvironment: (filenames: string[], originalContents: (string | undefined)[], environment: DangerContext, injectedObjectToExport?: any, moduleHandler?: ((module: any, filename: string) => string | Promise<any>) | undefined) => Promise<DangerResults>;
