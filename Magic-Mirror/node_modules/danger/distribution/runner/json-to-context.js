...
var danger_dsl_json_1 = require("./danger-dsl-json");
/**
 ...
 */
function jsonToContext(JSONString, program) {
    return __awaiter(this, void 0, void 0, function () {
        var dslJSON, dsl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dslJSON = { danger: new danger_dsl_json_1.DangerDSLJSON(JSONString, program) };
                    return [4 /*yield*/, jsonToDSL_1.jsonToDSL(dslJSON.danger)];
                case 1:
                    dsl = _a.sent();
                    return [2 /*return*/, Dangerfile_1.contextForDanger(dsl)];
            }
        });
    });
}
exports.jsonToContext = jsonToContext;
//# sourceMappingURL=json-to-context.js.map