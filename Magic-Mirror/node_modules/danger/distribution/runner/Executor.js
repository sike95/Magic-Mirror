...
var Executor = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.options.stdoutOnly || this.options.jsonOnly)) return [3 /*break*/, 2];
    ...
    Executor.prototype.handleResultsPostingToPlatform = function (originalResults, git) {
        return __awaiter(this, void 0, void 0, function () {
            var results, fails, warnings, messages, markdowns, failureCount, messageCount, dangerID, failed, previousComments, _i, previousComments_1, comment, s, are, previousComments, inline, inlineLeftovers, regular, mergedResults, issueURL, comment, urlForInfo, successPosting;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 12:
                        comment = process.env["DANGER_BITBUCKETSERVER_HOST"]
                            ? bitbucketServerTemplate_1.template(dangerID, mergedResults)
                            : githubIssueTemplate_1.template(dangerID, mergedResults);
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, this.platform.updateStatus(!failed, messageForResults(results), urlForInfo)];
                    case 15:
                        ...
                        _a.label = 16;
                    case 16:
                        if (!this.options.verbose) return [3 /*break*/, 18];
                        return [4 /*yield*/, this.handleResultsPostingToSTDOUT(results)];
                    case 17:
                        _a.sent();
                        _a.label = 18;
    ...
    Executor.prototype.sendInlineComments = function (results, git, previousComments) {
        ...
        return Promise.all(commentPromises).then(function (dangerResults) {
            return new Promise(function (resolve) {
                resolve(dangerResults.reduce(function (acc, r) { return DangerResults_1.mergeResults(acc, r); }, DangerResults_1.emptyDangerResults));
            });
        });
    };
    ...
    Executor.prototype.resultsForError = function (error) {
        ...
        console.error(chalk_1.default.red("Danger has failed to run"));
        console.error(error);
        return {
